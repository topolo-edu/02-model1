...
<head>
    <meta charset="UTF-8">
    <title>글쓰기 - EL + JSTL 버전</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">글쓰기 (3단계: EL + JSTL)</h1>
        ...
        <div class="mt-6 text-sm text-gray-600">
            <p>3단계: EL + JSTL 버전 - 단순한 HTML 폼</p>
            <p>특징: 폼 처리는 write_process.jsp에서 DAO를 사용하여 구현</p>
        </div>
    </div>
</body>
</html>
